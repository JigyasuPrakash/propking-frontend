...
function Title({ name, leadcount, paymentcount }) {
            ...
            <Grid container justify="space-evenly">
                ...
                <Grid item>
                    <Card className={classes.root}>
                        <CardContent>
                            <Typography variant="h6" component="h6">Lead Count</Typography>
                            <Typography>{leadcount}</Typography>
                        </CardContent>
                    </Card>
                </Grid>
                <Grid item>
                    <Card className={classes.root}>
                        <CardContent>
                            <Typography variant="h6" component="h6">Payment Count</Typography>
                            <Typography>{paymentcount}</Typography>
                        </CardContent>
                    </Card>
                </Grid>
                <Grid item>
